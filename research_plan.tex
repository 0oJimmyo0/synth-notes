...
\begin{enumerate}[nosep]
  ...
  \item run a small \textbf{source-fact-conditioned generation feasibility study}: derive an approved structured fact representation from each source discharge summary, condition generation or correction on those facts rather than on free text alone, and evaluate factual preservation before any regional scale-up,
